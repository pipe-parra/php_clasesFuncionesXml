...
function mostrarTodos(){
    ...
    //genero opciones de respuesta dependiendo el resultado que reciba y retorno el array de Elementos que creé
    if($arrElementos != null){
        echo "<p style='color: black;'>El array ha sido exportado y posee ".count($arrElementos)." elementos</p>";
    }else{
